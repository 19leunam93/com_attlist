 ...
 * @since  1.6
 */
class AttlistTablemeldung extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if($array['event_date'] == '0000-00-00' )
		{
			$array['event_date'] = '';
		}
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_attlist.meldung.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_attlist/access.xml',
				"/access/section[@name='meldung']/"
			);
			$default_actions = JAccess::getAssetRules('com_attlist.meldung.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_attlist.meldung.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_attlist');
