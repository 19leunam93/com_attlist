<?php
/**
 * Attendance-List Component Site meldung Controller
 * 
 * @package    Attlist
 ...
 * @since  1.6
 */
class AttlistControllerMeldung extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Meldung', 'AttlistModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_attlist') || $user->authorise('core.edit.state', 'com_attlist'))
		{
			$model = $this->getModel('Meldung', 'AttlistModel');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_attlist&view=meldungen', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_attlist'))
		{
			$model = $this->getModel('Meldung', 'AttlistModel');
			...
			else
			{
                ...
                $app->setUserState('com_attlist.edit.inventory.id', null);
                $app->setUserState('com_attlist.edit.inventory.data', null);

                $app->enqueueMessage(JText::_('COM_ATTLIST_ITEM_DELETED_SUCCESSFULLY'), 'success');
                $app->redirect(JRoute::_('index.php?option=com_attlist&view=meldungen', false));
			}
