<?php
/**
 * Attendance-List Component Site meldung Model
 * 
 * @package    Attlist
 ...
 * @since  1.6
 */
class AttlistModelMeldung extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_attlist')) && (!$user->authorise('core.edit', 'com_attlist')))
		{
            ...
            if ($this->_item === null)
            {
                ...
                if ($table->load($id))
                {
                    ...
                    if ($published = $this->getState('filter.published'))
                    {
                        ...
                        {
                            throw new Exception(JText::_('COM_ATTLIST_ITEM_NOT_LOADED'), 403);
                        }
                    }
					...
					$this->_item->present = JText::_('COM_ATTLIST_MELDUNGEN_PRESENT_OPTION_' . $this->_item->present);
